...
// This tells our express application to listen for local requests on port 3002.
app.listen(3002, function() {
	console.log('Server started and listening at localhost:3002');
});
...
// Our evil app will listen on port 3003.
evilApp.listen(3003, function() {
	console.log('"Evil" server started and listening at localhost:3003');
});
